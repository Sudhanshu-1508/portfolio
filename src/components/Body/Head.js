...
function Head() {
    ...
    function clickHandler(){
        window.open('https://drive.google.com/file/d/1w_DSopFUY-LfREjZgw2uJ8sj1rdN9d5L/view?usp=share_link')
    }
  ...
  return (
    <div className="heading">
      ...
      <button onClick={clickHandler} className="bttn">View Resume</button>
    </div>
  );
}
